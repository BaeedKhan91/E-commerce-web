...
import RelatedProducrs from '../components/RelatedProducrs';
...
function product() {
  ...
  return productData ?  (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        <div className='flex'>
          <b className='border px-5 py-3 text-sm'> Descriiption</b>
      ...
      <RelatedProducrs category={productData.category} subcategory={productData.subcategory}/>
    </div>
